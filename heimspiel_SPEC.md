...
| VBC | `https://www.viennabiocenter.org/career/open-vacancies/` → Liste parsen, Links folgen | täglich | Eine Seite, alle Campus-Institute und -Firmen. (Ursprüngliche URL `/career/open-positions/` ist inzwischen 404) |
